...
$(document).ready(function () {
  ...
  // zero table
  var table = $("#zero_configuration_table")
    .DataTable(config)
    .rows()
    .invalidate("data")
    .draw(false);
  $("#zero_configuration_table tbody").on("click", "button", function () {
    var data = table.row($(this).parents("tr")).data();
    console.log(data);
  });
  table.buttons().container().insertBefore("#zero_configuration_table_wrapper");
  table.fnClearTable();
  table.fnDestroy();
  $("#zero_configuration_table").empty();
