      ...
      <div className="row">
                ...
                <form>
                  <div class="row">
                    <div class="col-md-12 form-group mb-3">
                      <label for="sku" className="input-label-button">
                        <span> Test </span>
                        <button
                    ...
                    <div class="col-md-12 form-group mb-3">
                      <label for="color" className="input-label-button">
                        <span> Color </span>
                        <button
                          className="btn btn-primary btn-sm m-1"
                          type="button"
                    ...
                    <div class="col-md-12 form-group mb-3">
                      <label for="Size" className="input-label-button">
                        <span> Size </span>
                        <button
                          className="btn btn-primary btn-sm m-1"
                          type="button"
        ...
        >
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="createSkulabel">
                  create sku
                </h5>
                <button
                  type="button"
              ...
              <div class="modal-body">
                <from>
                  <div className="row">
                    ...
                    <div class="col-md-12 form-group mb-3">
                      <label for="skudescription">Description</label>
                      <input
                        class="form-control"
                        id="skudescription"
                        type="text"
                    ...
                    <div class="col-md-12 form-group mb-3">
                      <label for="skusmalldescription">Small Description</label>
                      <input
                        class="form-control"
